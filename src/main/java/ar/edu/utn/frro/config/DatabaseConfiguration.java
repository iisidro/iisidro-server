...
import ar.edu.utn.frro.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("ar.edu.utn.frro.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ar.edu.utn.frro.repository.search")
public class DatabaseConfiguration {
    ...
    public SpringLiquibase liquibase(DataSource dataSource, DataSourceProperties dataSourceProperties,
		...
		log.info("configuring liquibase w/ dataSource: " + dataSource);
